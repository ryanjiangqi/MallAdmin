...
//            imageSection.remove();
            ...
            if (!postUrl) {
                ...
                layer.msg("请设置要上传的服务端地址", function () {
                });
            ...
            if (imageNum + 1 > maxNum) {
                layer.msg("上传图片数目不可以超过" + maxNum + "个", function () {
                });
                return;
            }
            ...
            if (!isAllowFile(fileName, allowType)) {
                ...
                layer.msg("图片类型必须是" + allowType.join("，") + "中的一种", function () {
                });
            ...
            if (fileSize > maxSize) {
                ...
                layer.msg('上传图片不能超过' + maxSize + 'M，当前上传图片的大小为' + fileSize.toFixed(2) + 'M', function () {
                });
